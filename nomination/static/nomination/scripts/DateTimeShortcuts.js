...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        for (var i=0; i<scripts.length; i++) {
            if (scripts[i].src.match(/DateTimeShortcuts/)) {
                var idx = scripts[i].src.indexOf('nomination/scripts/DateTimeShortcuts');
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'nomination/images/icon_clock.gif', 'alt', gettext('Clock'));
...
//        today_link.appendChild(document.createTextNode(gettext('Today')));
        ...
        quickElement('img', cal_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'nomination/images/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
